...
function filterUnfundedOnly() {
    ...
    let unfundedOnly = GAMES_JSON.filter( (games) => {
...
function filterFundedOnly() {
    ...
    const fundedOnly = GAMES_JSON.filter( (games) => {
        return games.pledged >= games.goal;
    })
...
been raised for ${totalGamesCount} games. Currently, ${numUnfundedGames} 
game[s] remain[s] unfunded.
